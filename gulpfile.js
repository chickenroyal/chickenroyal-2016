...
gulp.task('scripts', function () {
	return gulp.src('app/js/**/*.js') 					// find all .js files
		//.pipe(concat('scripts.min.js')) 				// combine them into one file, named scripts.min.js
		.pipe(rename({suffix: '.min'})) 					// keep original file name add .min - use instead of above to keep all scripts separate.
